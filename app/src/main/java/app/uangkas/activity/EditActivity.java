...
//        Detail();
    ...
    private void Detail2(){
        ...
        final NumberFormat rupiahFormat = NumberFormat.getInstance(Locale.GERMANY);
        ...
        edit_jumlah.setText( M.jumlah ); txt_jumlah.setText( "Rp " + rupiahFormat.format( Double.parseDouble(M.jumlah) ) );
        ...
        edit_jumlah.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (edit_jumlah.getText().toString().equals("") || edit_jumlah.getText().toString().equals("0")){
                    txt_jumlah.setText("Rp 0");
                } else {

                    txt_jumlah.setText(
                            "Rp " + rupiahFormat.format( Double.parseDouble( edit_jumlah.getText().toString() ) )
                    );
                }
            }

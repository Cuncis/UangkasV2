...
//                startActivity(new Intent(MainActivity.this, AddActivity.class));
                if (max_input < 20) {
                    ...
                    Snackbar.make(view, "Maksimal input adalah 20", Snackbar.LENGTH_LONG).show();
                }
            }
        });
...
//        text_total.setText( rupiahFormat.format(cursor.getDouble(0)) );
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (i = 0; i < jsonArray.length(); i++) {
                                ...
                                map.put("jumlah",       rupiahFormat.format( responses.optDouble("jumlah")));
                                map.put("jumlah2",       responses.optString("jumlah"));
                            ...
                            if (i > 0){
                                ...
                                swipe_refresh.setRefreshing(false);
                                Toast.makeText(getApplicationContext(), "Data tidak ditemukan",
                                        Toast.LENGTH_LONG).show();
                            }
    ...
    private void Adapter(){
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.list_kas,
                new String[] {
                    "transaksi_id", "status", "jumlah", "jumlah2", "keterangan", "tanggal", "tanggal2"
                },
                new int[] {
                    R.id.text_transaksi_id, R.id.text_status, R.id.text_jumlah, R.id.text_jumlah2, R.id.text_keterangan,
        ...
        list_kas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                jumlah          = ((TextView) view.findViewById(R.id.text_jumlah2)).getText().toString(); Log.e("jumlah2", jumlah);
